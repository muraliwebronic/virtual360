      ...
      <div className="container max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-10 border-b border-gray-100 pb-16 mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
            <Link
              href={"/pricing#plans"}
              className="px-8 py-4 bg-[#2A74ED] rounded-xl font-bold text-white hover:bg-[#1a5fc7] transition-all duration-300 shadow-lg shadow-blue-500/20 flex items-center justify-center gap-2 group"
            >
              Get Started Free
              <ArrowRight
                size={18}
            ...
            <Link
              ...
              target="_blank"
              className="px-8 py-4 bg-white border border-gray-200 rounded-xl font-bold text-[#1A1A1A] hover:bg-gray-50 hover:border-gray-300 transition-all duration-300 text-center"
            >
              View Documentation
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-20">
          ...
          <div className="flex flex-col gap-4">
            ...
            {footerLinks.resources.map((link) => (
              <Link
                key={link.name}
                href={link.href}
                // Check if the link ends with .pdf, if so, open in new tab
          ...
          <div className="flex flex-col gap-4  ">
            ...
            <div className="flex flex-col gap-5 text-sm text-gray-500">
              {/* Address */}
              <Link target="_blank" href="https://maps.app.goo.gl/48QZzSupjJBGrUvv7"className="flex items-start gap-3">
