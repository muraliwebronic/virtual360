      ...
      <div className="grid grid-cols-1 gap-16 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7 rounded-[3rem] border border-gray-100 bg-white p-8 shadow-sm md:p-12">
          ...
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-2 rounded-[2rem] bg-[#2A74ED] py-5 text-lg font-bold text-white shadow-lg shadow-blue-500/20 transition-all hover:bg-[#1a5fc7]"
            >
              Submit Message
