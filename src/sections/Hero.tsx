        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left w-full">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-14 w-full">
              ...
              <button className="group w-full sm:w-auto pl-6 pr-8 py-3.5 bg-white text-gray-900 border border-gray-200 rounded-2xl font-semibold  sm:text-lg hover:bg-gray-50 hover:border-gray-300 transition-all duration-300 flex items-center justify-center gap-3 shadow-sm hover:shadow-md active:scale-[0.98]">
