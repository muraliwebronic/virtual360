  ...
  const plans: planType[] = [
    {
      ...
      // Corrected: Monthly is $6.99, Annual is $1.67
      price: isAnnual ? "$1.67" : "$6.99",
      
      // Corrected: Based on "Regular Price: $5.99" which is the basis for the 72% discount
      originalPrice: isAnnual ? "$5.99" : "$6.99", 
      
      discountBadge: isAnnual ? "72% OFF" : "", // No discount mentioned for monthly
      period: "/ month",
      ...
      features: [
        ...
        { text: "Maximum 5 Hotspots per Scene", included: true },
        { text: "Maximum 1 Site", included: true },

        { text: "Custom Brand Colors", included: false },
        { text: "Typography Controls", included: false },
        { text: "White Label Options", included: false },

        { text: "Shortcode Embedding", included: true },
        { text: "Mobile Responsive", included: true },
        { text: "Full Screen Mode", included: true },
        { text: "Web View Mode", included: true },
        { text: "Spatial Mode (Vision Pro & VR)", included: true },
    ...
    },
    {
      ...
      // Corrected: Monthly is $11.99, Annual is $5.83
      price: isAnnual ? "$5.83" : "$11.99",
      
      // Corrected: Based on "Regular Price: $9.99" which is the basis for the 42% discount
      originalPrice: isAnnual ? "$9.99" : "$11.99",
      
      discountBadge: isAnnual ? "42% OFF" : "", // No discount mentioned for monthly
      period: "/ month",
      ...
      features: [
        ...
        { text: "Unlimited Hotspots per Scene", included: true },
        { text: "Maximum 3 Sites", included: true },

        { text: "Custom Brand Colors", included: true },
        { text: "Typography Controls", included: true },
